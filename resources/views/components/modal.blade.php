...
@endphp
<div x-data="{ show: false }" x-on:open-modal.window="if ($event.detail == '{{ $id }}') show = true" x-on:close-modal.window="if ($event.detail == '{{ $id }}') show = false" x-show="show" class="fixed z-50 inset-0 overflow-y-auto" style="display: none;">
